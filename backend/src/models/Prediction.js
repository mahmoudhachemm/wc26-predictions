...
const predictionSchema = new mongoose.Schema(
  {
    ...
    // Cup H2H joker only
    // Chips do not count in cup, so cup has its own joker.
    isCupJoker: {
      type: Boolean,
      default: false,
    },
    ...
    // Normal prediction points before jokers/chips
    basePoints: {
      type: Number,
      default: 0,
    },

    // General leaderboard points.
    // Chips count here.
    points: {
      type: Number,
      default: 0,
    ...
    // Only isCupJoker can double points.
    cupPoints: {
      type: Number,
      default: 0,
    },
